from tasks.list_basics.make_stickers import make_stickers


def test_body_list():
    assert make_stickers.make_stickers(3, "Body") == [
        "Body detail #1",
        "Body detail #2",
        "Body detail #3",
    ], (
...
def test_head_list():
    assert make_stickers.make_stickers(4, "Head") == [
        "Head detail #1",
        "Head detail #2",
        "Head detail #3",
        "Head detail #4",
...
def test_empty_list_when_details_count_is_0():
    assert make_stickers.make_stickers(0, "Foot") == [], (
...
def test_long_list():
    ...
    assert make_stickers.make_stickers(10, "Hand") == hands_list, (
