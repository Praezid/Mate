from tasks.list_basics.get_speed_statistic import get_speed_statistic


def test_zeros_when_test_results_is_empty():
    assert get_speed_statistic.get_speed_statistic([]) == [0, 0, 0], (
...
def test_single_element_list():
    assert get_speed_statistic.get_speed_statistic([10]) == [10, 10, 10], (
...
def test_int_average():
    assert get_speed_statistic.get_speed_statistic([10, 10, 11, 9, 12, 8]) == [8, 12, 10], (
...
def test_float_average():
    assert get_speed_statistic.get_speed_statistic([8, 9, 9, 9]) == [8, 9, 8], (
...
def test_float_max_when_test_results_contains_float_values():
    assert get_speed_statistic.get_speed_statistic([4.5, 6.7, 9.2, 1]) == [1, 9.2, 5], (
