from tasks.working_with_string.decrypt_message import decrypt_message


def test_long_message():
    assert (
            decrypt_message.decrypt_message("!!!reeb gniknird ekil eW")
...
def test_message_with_numbers():
    assert (
            decrypt_message.decrypt_message("0202 ni eb lliw cimednap surivanoroc A")
...
def test_mate_academy_message():
    assert decrypt_message.decrypt_message("!ymedaca etaM evol I") == "I love Mate academy!", (
