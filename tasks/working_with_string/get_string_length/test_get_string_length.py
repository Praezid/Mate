from tasks.working_with_string.get_string_length import get_string_length


def test_0_when_empty_string():
    assert (
        get_string_length.get_string_length("") == 0
    ), "Function 'get_string_length' should return 0 when string is empty"


def test_1_when_string_is_a_single_character():
    assert (
        get_string_length.get_string_length("b") == 1
