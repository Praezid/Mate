from tasks.extra_tasks.split_string import split_string


def test_underscored_char_when_string_is_one_character():
    assert split_string.split_string("a") == ["a_"], (
...
def test_same_string_when_string_length_is_two():
    assert split_string.split_string("bb") == ["bb"], (
...
def test_odd_length_string():
    assert split_string.split_string("abcde") == ["ab", "cd", "e_"], (
        "Function 'split_string' should return an array of two-character strings "
...
def test_long_string_with_even_length():
    assert split_string.split_string("HYWqtNAMPDIpofCfvkyC") == [
        "HY",
        "Wq",
        "tN",
        "AM",
...
def test_long_string_with_odd_length():
    assert split_string.split_string("mtdUmBfzMoafzbrHijC") == [
        "mt",
        "dU",
        "mB",
        "fz",
...
def test_string_with_underscore():
    assert split_string.split_string("abcd_") == ["ab", "cd", "__"], (
